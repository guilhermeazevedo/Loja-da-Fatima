...
public class InterfaceFormaPagto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.add(TfForma, new org.netbeans.lib.awtextra.AbsoluteConstraints(128, 31, 200, -1));
        ...
        jPanel1.add(BtGravar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 69, 89, -1));
        ...
        jPanel1.add(BtLimpar, new org.netbeans.lib.awtextra.AbsoluteConstraints(109, 69, 85, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 318, 161));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 267, 318, -1));
    ...
    private void BtGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtGravarActionPerformed
        if(!TfForma.getText().equals("")){
            ...
            if(TfCodigo.getText().equals("")){
                if(forma.incluir()){
                    msg.Sucesso(LbNotificacao, "Dados da Forma de Pagamento gravados com sucesso!");
                }
            }else{
                forma.setCodigo(Integer.parseInt(TfCodigo.getText()));
                if(forma.alterar()){
                    msg.Sucesso(LbNotificacao, "Dados da Forma de Pagamento alterados com sucesso!");
                }
            }
            limpa.Limpar(jPanel1);
            preenche.PreencherJtable(TbConsulta, forma.retornaformapgtojtable());
        }else{
            msg.CampoObrigatorioNaoPreenchido(LbNotificacao, "Digite a descrição da forma de pagamento!");
            TfForma.grabFocus();
        }
