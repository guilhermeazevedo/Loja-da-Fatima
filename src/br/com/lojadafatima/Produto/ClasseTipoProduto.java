...
public class ClasseTipoProduto {
    ...
    public ResultSet buscartiposproduto(){
        conn.executeSQL("SELECT \"CD_TIPO_PRODUTO\", \"DS_TIPO_PRODUTO\"\n" +
    ...
    public void incluir(){
        ...
        conn.incluirSQL("INSERT INTO bancoloja.\"CAD_TIPO_PRODUTO\"(\n" +
                        "\"CD_TIPO_PRODUTO\", \"DS_TIPO_PRODUTO\")\n" +
                        "VALUES ("+getCodigo()+", '"+getTipoproduto().toUpperCase()+"');");
    }
    ...
    public void alterar(){
        getTabela().conn.atualizarSQL("UPDATE bancoloja.\"CAD_TIPO_PRODUTO\"\n" +
                          "SET \"DS_TIPO_PRODUTO\"='"+getTipoproduto().toUpperCase()+"'\n" +
                          "WHERE \"CD_TIPO_PRODUTO\"="+getCodigo()+";");
    }
